...
public class insert_articles extends JFrame implements ActionListener{
	...
	JLabel l2 = new JLabel("Journal Title");
...
//	contentPane.add(comboBox_3);
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Add-Article",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                	conn con = new conn();
                String sql = "INSERT INTO articles(isbn,journal_title,publisher_name,publication_date,editors,authors)\n"
                		+ "VALUES(?,?,?,?,?,?);";

...
public class insert_records extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Record id");
	...
	JLabel l4 = new JLabel("Issue/Return");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Add-Record",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                	conn con = new conn();
                String sql = "insert into records(record_id,isbn,member_id,issueorreturn)\n"
                		+ "values(?,?,?,?);";

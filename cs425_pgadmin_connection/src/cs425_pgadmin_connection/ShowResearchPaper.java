...
public class ShowResearchPaper extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Research Paper");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Research-Paper",

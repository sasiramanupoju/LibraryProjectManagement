...
public class Query2 extends JFrame implements ActionListener{
	...
	try {
            conn con = new conn();
            String sql = "select members.first_name,members.last_name,members.email \n"
            		+ "from members natural join records\n"
            		+ "where records.issueorreturn = 'return';";
	...
	JLabel l1 = new JLabel("Showing the Members who returned book");

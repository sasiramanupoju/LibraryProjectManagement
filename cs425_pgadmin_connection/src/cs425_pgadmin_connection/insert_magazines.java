...
public class insert_magazines extends JFrame implements ActionListener{
	...
	JLabel l2 = new JLabel("Magazine Name");
	l2.setForeground(new Color(25, 25, 112));
	l2.setFont(new Font("Tahoma", Font.BOLD, 14));
	l2.setBounds(20, 97, 200, 22);
	contentPane.add(l2);

	JLabel l3 = new JLabel("Published Time");
	...
	JLabel l6 = new JLabel("Editors");
	l6.setForeground(new Color(25, 25, 112));
	l6.setFont(new Font("Tahoma", Font.BOLD, 14));
	l6.setBounds(20, 176, 200, 22);
	contentPane.add(l6);

	JLabel l4 = new JLabel("Contributors");
...
//	contentPane.add(comboBox_3);
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Add-Magazine",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                	conn con = new conn();
                String sql = "INSERT INTO magazines(isbn,magazine_name,published_time,editors,contributors)\n"
                		+ "VALUES(?,?,?,?,?);";

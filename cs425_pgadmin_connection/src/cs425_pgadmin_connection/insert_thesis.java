...
public class insert_thesis extends JFrame implements ActionListener{
	...
	JLabel l3 = new JLabel("Advisor Name");
	...
	JLabel l6 = new JLabel("Completion Date");
...
//	contentPane.add(comboBox_3);
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Add-Thesis",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                	conn con = new conn();
                String sql = "INSERT INTO thesis(isbn,authors,advisor_name,completed_date)\n"
                		+ "VALUES(?,?,?,?);";

...
public class ShowTakesRelation extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Takes Relation");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Takes-Relation",

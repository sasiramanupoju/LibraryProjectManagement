...
public class ShowDocuments extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Document Details");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Document-Details",

...
public class ShowLibrarians extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Librarian Details");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Librarian-Details",

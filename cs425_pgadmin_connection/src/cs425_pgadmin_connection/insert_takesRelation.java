...
public class insert_takesRelation extends JFrame implements ActionListener{
    ...
    public insert_takesRelation() {
        super("Takes Relation");
	...
	JLabel l2 = new JLabel("Date Taken");
...
//	contentPane.add(comboBox_3);
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Takes-Relation",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                	conn con = new conn();
                String sql = "INSERT INTO takes(isbn,date_taken,due_date)\n"
                		+ "VALUES(?,?,?);";
